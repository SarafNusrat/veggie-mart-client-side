    ...
    return (
        <div>
            <section class="mb-20 text-gray-700">
                <div class="text-center md:max-w-xl lg:max-w-3xl mx-auto pt-8 pl-8 pr-8">
                    <p class="mb-6 pb-2 font-bold text-green-800 md:mb-12 md:pb-0 text-center">
                        Meet the best team who dream of Veggie Mart 24/7. This is our everyday motivation to go back to the work.
                    </p>
                </div>

                <div class="grid md:grid-cols-3 gap-6 lg:gap-12 text-center pl-20 pr-20">
                    <div class="mb-12 md:mb-0">
                        ...
                        <p class="mb-4">
                            ...
                            It's amazing when i feel the Veggie Mart web system is done by me. I am so glad to be a part of this amazing team.
                        </p>
